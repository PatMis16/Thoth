...
jobs:
  deploy:
    ...
    permissions:
      ...
      pull-requests: write
    steps:
      - uses: PatMis16/Thoth/actions/instrument/deploy@v5.16.5
        env:
...
jobs:
  export:
    runs-on: ubuntu-latest
    steps:
      - uses: PatMis16/Thoth/actions/instrument/workflow@main
        env:
...
```yaml
- uses: PatMis16/Thoth/actions/instrument/job@main
  env:
